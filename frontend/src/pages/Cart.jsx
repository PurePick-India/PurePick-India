        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <br /><span className="text-lg text-primary">{getCartCount()} Items</span>
                </h1>
                ...
                <button onClick={() => { navigate("/products"); scrollTo(0, 0) }} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary text-xl font-medium">
                    <img className='w-6 h-6 group-hover:-translate-x-1 transition' src={assets.arrow_right_icon_colored} alt='arrow' />
                    Continue Shopping
                </button>
            </div>

            {/* Order Summary */}
            <div className="max-w-[360px] w-full h-[500px] bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70 overflow-hidden">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p
                            className="text-gray-500 truncate whitespace-nowrap overflow-hidden max-w-[220px]"
                            title={selectedAddress ? `${selectedAddress.street}, ${selectedAddress.city}, ${selectedAddress.state}, ${selectedAddress.country}` : "No address found"}
                        >
                            {selectedAddress
